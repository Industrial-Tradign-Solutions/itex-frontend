...
export class HistoryQuotationModalComponent implements OnInit {
  ...
  getData(key: string) {
    const actionMap: Record<string, string> = {
      ...
      totalFreightCharges: 'Total Freight Charges',
      profitMarginFreightCharges: 'Profit Margin Freight Charges',
      freightChargeMiamiITS: 'Freight Charge Miami ITS',
